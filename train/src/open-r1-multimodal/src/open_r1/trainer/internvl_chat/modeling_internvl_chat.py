...
class InternVLChatModel(PreTrainedModel):
    ...
    def forward(
        ...
        #     max_new_tokens=24,
        #     do_sample=True,
        #     eos_token_id=151645,   # ✅ 正确设置
        #     pad_token_id=151643,    # ✅ 必须加上，避免 generate 报错
        ...
        #     response = tokenizer.batch_decode(outputs2, skip_special_tokens=True)[0]
        #     print('response',response)

        #     print("outputs3", outputs2)
